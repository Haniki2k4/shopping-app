        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-12">
                        <h3 class="card-title" style="padding-top:4px; font-style: italic">Danh sách Chuyên Mục</h3>
                    </div>
                    <div style="float: right">
                        <button wire:click="addCategory()" class="btn btn-success"
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <button class="badge text-bg-warning" style="font-size:14px"><i class="far fa-edit"
                                                    wire:click="editCategory({{ $item->id }})"></i></button>
                                            <button class="badge text-bg-danger" style="font-size:14px"><i class="fas fa-ban"
                                                    wire:click="delCategory({{ $item->id }})"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
